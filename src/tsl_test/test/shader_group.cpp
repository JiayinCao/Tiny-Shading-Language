...
TEST(ShaderGroup, ShaderGroupRecursive) {
    ...
    auto ret = shader_group1->add_shader_unit(final_shader_unit, true);
    EXPECT_EQ(true, ret);
    ret = shader_group1->add_shader_unit(shader_group0);
    EXPECT_EQ(true, ret);
    ret = shader_group1->add_shader_unit(constant_shader_unit);
    EXPECT_EQ(true, ret);
