...
%type <p> STATEMENT STATEMENTS STATEMENT_RETURN STATEMENT_EXPRESSION_OPT STATEMENT_COMPOUND_EXPRESSION STATEMENT_VARIABLES_DECLARATIONS VARIABLE_DECLARATION VARIABLE_DECLARATIONS STATEMENT_CONDITIONAL STATEMENT_LOOP STATEMENT_SCOPED STATEMENT_LOOPMOD STATEMENT_MULTI_VARIABLES_DECLARATIONS
...
STRUCT_DEF:
	"struct" ID "{" STATEMENT_MULTI_VARIABLES_DECLARATIONS "}" ";"
	{
	};

STATEMENT_MULTI_VARIABLES_DECLARATIONS:
	STATEMENT_VARIABLES_DECLARATIONS
	|
	STATEMENT_MULTI_VARIABLES_DECLARATIONS STATEMENT_VARIABLES_DECLARATIONS
	{
	}
	;
